...
This course focus on creating, managing, and shaping policies in RHACS by following recommended strategies.
...
```
    $ git clone git@github.com:RedHatQuickCourses/rhacs-policy-management.git
```

2. Install the npm dependencies for the course tooling.
```
    $ cd rhacs-policy-management
    $ npm install
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/rhacs-policy-management

## Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/rhacs-policy-management/issues